...
# Update the local Voyage Chief PC install from GitHub (still runs locally afterward).
...
Write-Host "Updating local Voyage Chief from $NoonReportRepo @ $NoonReportBranch (local install only)..." -ForegroundColor Yellow
